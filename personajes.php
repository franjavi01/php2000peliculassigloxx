    ...
    <div class="row">
        <div class="col-md-4">
            <form action="personajes.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="Rol_principal" class="form-label">Rol Principal:</label>
                    <input type="radio" class="form-control" name="Rol_principal">
                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($resultado)) { ?>
                        <tr>
                            ...
                            <td><?php echo $row['Rol_principal']; ?></td>
                            <td><?php echo $row['Imagen']; ?></td>
                            <!-- <td><?php echo $row['Texto']; ?></td> -->
                            <td>
                                
                            <a href="edit.php?id=<?php echo $row['id']; ?>" class="btn btn-primary" role="button">
                            ...
                            <td><a href="delete.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" role="button" >                                    
